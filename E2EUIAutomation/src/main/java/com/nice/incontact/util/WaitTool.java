...
public class WaitTool {
	private static final SeleniumLogger log = new SeleniumLogger(WaitTool.class);
	...
	public static WebElement waitForElementPresent(WebDriver driver, final By by, int timeOutInSeconds) {
        ...
        try{
            ...
            log.warn("waitForElementPresent", "Element not found within "+ timeOutInSeconds+ " seconds!!!!");
            log.warn("waitForElementPresent", "Element locator "+ by);
       } 
        return element;
    }
     ...
     */
    public static WebElement waitForElementPresentByXpath(WebDriver driver, String locator, int timeOutInSeconds) {
    ...
    public static List<WebElement> waitForListElementsPresent(WebDriver driver, final By by, int timeOutInSeconds) {
        ...
        try {
            ...
            log.warn("waitForListElementsPresent", "Elements not found within " + timeOutInSeconds + " seconds!!!!");
            log.warn("waitForListElementsPresent", "Element locator " + by);
        }
        return elements;
    }
     ...
     *         null (if the timeout is reached)
     */
    public static List<WebElement> waitForListElementsPresentbyXpath(WebDriver driver, String locator, int timeOutInSeconds) {
...
public static void sleep(long seconds){
	try {
		...
		log.error("sleep", "Exception thrown by sleep");
	}
}
 }
/*
